...
//Cilindros laterais
var cylinderGeometryYellow = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25)
var cylinderMaterialYellow = new THREE.MeshPhongMaterial( {color:'rgb(255,215,0)'} );
var cylinderYellowLeft = new THREE.Mesh( cylinderGeometryYellow,  cylinderMaterialYellow  );
var cylinderYellowRight = new THREE.Mesh( cylinderGeometryYellow,  cylinderMaterialYellow  );
cylinder2.add(cylinderYellowLeft)
cylinder2.add(cylinderYellowRight)
...
function rotateCylinder()
{
  ...
  cylinderYellowLeft.matrixAutoUpdate = false;
  cylinderYellowRight.matrixAutoUpdate = false;
  ...
  if(animationOn)
  {
    ...
    cylinderYellowLeft.matrix.identity();
    cylinderYellowRight.matrix.identity();
    ...
    // Amarelinhos
    cylinderYellowLeft.matrix.multiply(mat4.makeRotationY(angle2));
    cylinderYellowLeft.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0));
    cylinderYellowLeft.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));

    cylinderYellowRight.matrix.multiply(mat4.makeRotationY(-angle2));
    cylinderYellowRight.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0));
    cylinderYellowRight.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
  }
}

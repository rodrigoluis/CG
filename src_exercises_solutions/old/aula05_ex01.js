function main()
{
  ...
  // cylinder adicional 1
  var cylinderGeometry2 = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
  var cylinderMaterial2 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,0)'} );
  var cylinder3 = new THREE.Mesh( cylinderGeometry2, cylinderMaterial2 );
  cylinder2.add(cylinder3);

  // cylinder adicional 2
  var cylinderGeometry2 = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
  var cylinderMaterial2 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,0)'} );
  var cylinder4 = new THREE.Mesh( cylinderGeometry2, cylinderMaterial2 );

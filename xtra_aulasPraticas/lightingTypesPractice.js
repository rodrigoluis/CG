...
let lightPosition = new THREE.Vector3(1.5, 1.2, 0.2);
...
let currentLight = dirLight; // current light
...
export function createLightSphere2(scene, radius, widthSegments, heightSegments, position)
{
  var geometry = new THREE.SphereGeometry(radius, widthSegments, heightSegments, 0, Math.PI * 2, 0, Math.PI);
  var material = new THREE.MeshBasicMaterial({color:"rgb(0,255,50)"});
...
function setSpotLight(position)
{
  ...
  let lightSphere2 = createLightSphere2(scene, 0.05, 10, 10, spotLight.target.position);  
